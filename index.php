        ...
        <div class="container">
            ...
            <?php 
                ...
                $faqs=[
                    ...
                    [
                        'question'=> "<h2 class='question'>Perché il mio account è associato a un paese?</h2>",
                        'paragraphs' =>[
                ...
                foreach ($faqs as $faq) {
                    echo '<div>'.$faq['question'];
                    foreach($faq['paragraphs'] as $paragraph){
                        echo '<p class="answer">'.$paragraph.'</p>';
                    }
                    echo '</div>';
                };
    ...
    <footer>
        <div class="container">
            ...
            <section id="useful-infos">
                <ul>
                    <li><a class="small-text" href="">Google</a></li>
                    <li><a class="small-text" href="">Tutto su Google</a></li>
                    <li><a class="small-text" href="">Privacy</a></li>
                    <li><a class="small-text" href="">Termini</a></li>
                </ul>
            </section>
            <section id="language">
